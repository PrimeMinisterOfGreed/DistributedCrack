...
Dalle simulazioni appare chiaro che il metodo più veloce sia il primo proposto che sfrutta la ricerca lineare, tuttavia bisogna tenere a mente che buona parte di queste valutazioni non comprendono molte variabili di un sistema molto complesso. Ad esempio , è vero che nel caso della DHT non si sta parallelizzando praticamente per nulla l'esecuzione , tuttavia un metodo del genere genera molti pochi accessi in memoria e richiede l'esecuzione di molte meno istruzioni rispetto al metodo lineare, per cui l'unico modo di ottenere dei risultati precisi è quello di effettuare un benchmark.
