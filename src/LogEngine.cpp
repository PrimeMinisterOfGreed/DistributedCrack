...
void SendStream(boost::mpi::communicator &comm, std::istream &stream,
                int processTarget) {
...
MPILogEngine::MPILogEngine(boost::mpi::communicator &comm,
                           std::istream *loadStream, std::ostream *saveStream,
                           int verbosity)
    : _loadStream{loadStream}, _saveStream{saveStream}, _communicator{comm},
...
void MPILogEngine::CreateInstance(boost::mpi::communicator &comm,
                                  std::istream *loadStream,
                                  std::ostream *saveStream, int verbosity) {
  MPILogEngine::_instance =
      new MPILogEngine(comm, loadStream, saveStream, verbosity);
}

ILogEngine *MPILogEngine::Instance() { return MPILogEngine::_instance; }
