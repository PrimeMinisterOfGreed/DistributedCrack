...
//__device__ __host__ void md5(const uint8_t *data, uint32_t size, uint32_t result[4]);

__host__ void md5_gpu(const uint8_t **data, const uint32_t * sizes, uint32_t** result, uint32_t size, int threads);
